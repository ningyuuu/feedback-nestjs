...
export class Migration20230423144902 extends Migration {
  ...
  async down(): Promise<void> {
    ...
    this.addSql(
      'alter table "student" add constraint "student_project_id_foreign" foreign key ("project_id") references "project" ("id") on delete cascade;',
    );
  }
}
